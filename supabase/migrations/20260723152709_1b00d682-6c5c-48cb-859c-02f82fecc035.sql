...
-- SHA-256: 46273cc7663e52fada30adbf1bc6cb634ba581d4dc85d60caeb971a02652237e
...
BEGIN
  ...
  SELECT count(*) INTO v_bad
   ...
   WHERE b.resolved_slug NOT IN (SELECT slug FROM public.civiko_commercial_zones);
...
-- 4. Backfill: copy structured quartiere; trigger sets commercial_zone_slug
WITH upd AS (
