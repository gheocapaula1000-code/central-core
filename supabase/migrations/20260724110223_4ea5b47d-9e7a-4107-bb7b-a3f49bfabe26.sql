-- ============================================================================
-- Fase 1B: scraping_queue RESULT PROCESSING layer + pg_cron dispatch/reaper
-- Copia di docs/pending-migrations/20260719_scraping_result_processor.sql
-- Prerequisiti verificati: vault.secrets 'scraping_result_processor_url' e
-- 'scraping_worker_token' esistono.
-- ============================================================================
