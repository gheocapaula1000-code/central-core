...
export const ZONA_ALIASES = ["COD_ZON", "cod_zon", "zona", "ZONA", "codice_zona", "CODICE_ZONA", "zone_code"];
...
export const CATASTALE_ALIASES = ["COM_CAT", "com_cat", "comune_catastale", "COMUNE_CATASTALE", "cod_catastale", "COD_CATASTALE"];
