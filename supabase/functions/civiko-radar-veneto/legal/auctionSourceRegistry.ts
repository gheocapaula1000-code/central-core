...
export const AUCTION_SOURCE_REGISTRY: AuctionSource[] = [
  ...
  // ── Aste Giudiziarie .it (portale pubblico, robots permissive su listings)
  {
    ...
    provincial_seeds: [
      { province: "PD", paths: ["/immobili/provincia-di-padova"] },
      { province: "VE", paths: ["/immobili/provincia-di-venezia"] },
      { province: "VR", paths: ["/immobili/provincia-di-verona"] },
      { province: "VI", paths: ["/immobili/provincia-di-vicenza"] },
      { province: "TV", paths: ["/immobili/provincia-di-treviso"] },
      { province: "BL", paths: ["/immobili/provincia-di-belluno"] },
      { province: "RO", paths: ["/immobili/provincia-di-rovigo"] },
    ],
