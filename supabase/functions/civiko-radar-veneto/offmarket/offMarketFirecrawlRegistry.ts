...
export const OFFMARKET_FIRECRAWL_REGISTRY: OffMarketFirecrawlSource[] = [
  // ─── PADOVA ────────────────────────────────────────────────
  {
    ...
    allowed_paths: ["/informazione/urbanistica", "/informazione/piano", "/urbanistica/"],
    excluded_paths: X(),
  ...
  },
  {
    ...
    allowed_paths: ["/informazione/lavori-pubblici", "/informazione/cantieri", "/notizia/", "/informazione/gara"],
    excluded_paths: X(),
  ...
  },
  {
    ...
    allowed_paths: ["/informazione/avvisi", "/informazione/patrimonio", "/informazione/aste", "/informazione/bandi"],
    excluded_paths: X(),
