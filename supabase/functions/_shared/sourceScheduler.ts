...
export const SOURCE_PLAN: Record<string, SourcePlan> = {
  ...
  F18: { code: "F18", automation_status: "automated",         scheduler_frequency: "monthly",    stale_after_days: 60,  job: "civiko-sue-padova-collect", ingestion_endpoint: "/civiko-sue-padova-collect", cross_check_enabled: false, notes: "SUE Padova: official Comune pages + CKAN Padova-only + OSM construction. Live table may still be 0 / manual_import until collector is deployed. Empty is success — never invent permits. CSV import remains /import/sue-permits + compliance_verified." },
  ...
  F21: { code: "F21", automation_status: "automated",         scheduler_frequency: "daily",      stale_after_days: 3,   job: "civiko-radar-veneto", ingestion_endpoint: "/civiko-radar-veneto/jobs/deep-scan-padova", cross_check_enabled: true, notes: "Live listings path is Firecrawl scraping_queue / padova_portal_collect_v2 (Immobiliare+Idealista+Subito-soft+Bakeca). Casa Apify casa_collect is live. Immobiliare/Idealista/Subito Apify nightlies are stale — do not treat Apify last_success as freshness." },
...
export const AUTOMATED_TRIGGERS: Record<string, TriggerSpec> = {
  ...
  F18: { cron_job: "official-sue-padova",                 schedule: "0 5 2 * *",  endpoint: "/civiko-sue-padova-collect" },
