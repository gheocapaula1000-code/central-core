...
export const SOURCE_PLAN: Record<string, SourcePlan> = {
  ...
  F21: { code: "F21", pipeline_class: "C", automation_status: "automated",         scheduler_frequency: "daily",      stale_after_days: 3,   job: "cron-apify-*-nightly", ingestion_endpoint: "/cron-apify-immobiliare-nightly", write_table: "padova_listings", cross_check_enabled: true, notes: "Portals: portal-immobiliare/idealista/subito/casa-padova → cron-apify-*-nightly + portal-collect-pending. Fail-closed. Not mixed into official crons." },
