-- Patch chirurgica: ramo Idealista di promote_padova_collect_v2_to_listings
-- copia tipo_lead dalla sorgente quando vale AGENZIA/PRIVATO, altrimenti NULL (fail-closed).
-- Nessuna modifica al ramo altri portali.
...
BEGIN
  ...
  WITH src_id AS (
    SELECT DISTINCT ON (portal, url)
      portal, url, raw_address, agency, agency_phone,
      prezzo, mq, locali, bagni, lat, lng,
      -- fail-closed: solo AGENZIA/PRIVATO espliciti sono accettati, altrimenti NULL
