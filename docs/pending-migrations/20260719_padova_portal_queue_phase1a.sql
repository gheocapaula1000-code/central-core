-- ============================================================================
-- Fase 1A shadow mode — process_padova_portal_collect_v2 (corretta v2)
...
--          Nessuna estensione (niente unaccent).
-- ============================================================================
...
BEGIN
  ...
  END IF;
  IF v_portal IS NULL
     OR v_portal NOT IN ('immobiliare.it','idealista.it','casa.it','subito.it') THEN
